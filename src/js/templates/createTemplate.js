...
export function createTemplate ({avatar, firstName, status, lastName, email, phoneNumber, experience, type, id, ...rest}){
   ...
   <aside> 
    ...
    />
       ...
       <li class="edit-developer" data-id="${id}">
      ...
      <g>
       ...
       <li class="delete-developer" data-id="${id}"><svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
      <g>
